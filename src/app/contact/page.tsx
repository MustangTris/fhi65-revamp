...
export const metadata: Metadata = {
    title: "Contact Us",
    description: "Get in touch with Foulds Health Insurance for expert Medicare advice. Visit our La Quinta office, call us, or send a message. We're here to help.",
    alternates: {
        canonical: '/contact',
    },
};
