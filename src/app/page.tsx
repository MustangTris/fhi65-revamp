...
export default function Home() {
  return (
    <div className="flex flex-col">
      {/* Hero Section */}
      <section className="relative overflow-hidden min-h-[700px] flex flex-col lg:flex-row">
      ...
      <section className="py-24 relative z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <div className="inline-block bg-white/60 backdrop-blur-md rounded-full px-8 py-3 shadow-sm mb-6 border border-white/40">
              <h2 className="text-2xl md:text-3xl font-bold text-[#1e9cd7] uppercase tracking-wide">How It Works</h2>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {/* Step 1 */}
            <div className="flex flex-col items-center text-center p-8 bg-white/60 backdrop-blur-md rounded-3xl border border-white/40 shadow-sm hover:-translate-y-2 transition-all duration-300">
              <div className="w-16 h-16 bg-gradient-to-br from-[#005d9a] to-[#1e9cd7] text-white rounded-full flex items-center justify-center text-2xl font-bold mb-6 shadow-lg">1</div>
            ...
            {/* Step 2 */}
            <div className="flex flex-col items-center text-center p-8 bg-white/60 backdrop-blur-md rounded-3xl border border-white/40 shadow-sm hover:-translate-y-2 transition-all duration-300">
              <div className="w-16 h-16 bg-gradient-to-br from-[#005d9a] to-[#1e9cd7] text-white rounded-full flex items-center justify-center text-2xl font-bold mb-6 shadow-lg">2</div>
            ...
            {/* Step 3 */}
            <div className="flex flex-col items-center text-center p-8 bg-white/60 backdrop-blur-md rounded-3xl border border-white/40 shadow-sm hover:-translate-y-2 transition-all duration-300">
              <div className="w-16 h-16 bg-gradient-to-br from-[#005d9a] to-[#1e9cd7] text-white rounded-full flex items-center justify-center text-2xl font-bold mb-6 shadow-lg">3</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="md:w-1/2 text-center md:text-left">
              ...
              <Link
                href="/about"
                className="text-[#1e9cd7] font-bold text-lg hover:text-[#005d9a] transition-colors inline-flex items-center"
              >
